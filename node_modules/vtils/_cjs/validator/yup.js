...
yup.addMethod(yup.string, 'chineseMobilePhoneNumber', function (message) {
  ...
  return this.test('chineseMobilePhoneNumber', message, _utils.isPossibleChineseMobilePhoneNumber);
...
yup.addMethod(yup.string, 'chineseIDCardNumber', function (message) {
  ...
  return this.test('chineseIDCardNumber', message, _utils.isChineseIDCardNumber);
