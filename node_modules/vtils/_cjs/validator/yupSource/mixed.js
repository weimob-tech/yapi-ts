...
var RefSet = /*#__PURE__*/function () {
  ...
  _proto.describe = function describe() {
    ...
    for (var _iterator = (0, _createForOfIteratorHelperLoose2.default)(this.list), _step; !(_step = _iterator()).done;) {
      var item = _step.value;
      description.push(item);
    }

    for (var _iterator2 = (0, _createForOfIteratorHelperLoose2.default)(this.refs), _step2; !(_step2 = _iterator2()).done;) {
  ...
  _proto.toArray = function toArray() {
    return (0, _utils.toArray)(this.list).concat((0, _utils.toArray)(this.refs.values()));
  };
...
function SchemaType(options) {
  ...
  if ((0, _utils.has)(options, 'default')) this._defaultDefault = options.default;
...
var proto = SchemaType.prototype = {
  ...
  clone: function clone() {
    ...
    return (0, _utils.cloneDeepWith)(this, function (value, key) {
  ...
  concat: function concat(schema) {
    ...
    if ((0, _utils.has)(schema, '_default')) next._default = schema._default;
  ...
  _cast: function _cast(rawValue) {
    ...
    if (value === undefined && (0, _utils.has)(this, '_default')) {
  ...
  _getDefault: function _getDefault() {
    var defaultValue = (0, _utils.has)(this, '_default') ? this._default : this._defaultDefault;
    return typeof defaultValue === 'function' ? defaultValue.call(this) : (0, _utils.cloneDeepWith)(defaultValue);
  },
  ...
  _option: function _option(key, overrides) {
    return (0, _utils.has)(overrides, key) ? overrides[key] : this._options[key];
  },
