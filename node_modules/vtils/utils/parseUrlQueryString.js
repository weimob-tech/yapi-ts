 ...
 * ```
 */
export function parseUrlQueryString(query, options) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(query.split(partSeparator)), _step; !(_step = _iterator()).done;) {
